...
object EventIdentityNormalizer {
    ...
    private val adjectiveRegex =
        Regex("""\b(правильный|правильного|правильным|правильной|лучший|лучшего|новый|старый|большой|маленький|крутой|классный|интересный|полезный|важный|главный)\b""")
